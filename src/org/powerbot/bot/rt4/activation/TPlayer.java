...
public class TPlayer implements TextPaintListener {
	...
	public int draw(int idx, final Graphics render) {
		...
		DebugHelper.drawLine(render, idx++, String.format("[%s] A: %d, CBL: %d, T: %d, S: %d, INT: %s", player.name(), player.animation(), player.combatLevel(), player.team(), player.speed(), player.interacting()));
