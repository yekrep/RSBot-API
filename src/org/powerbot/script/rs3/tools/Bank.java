...
public class Bank extends ItemQuery<Item> {
	...
	private Interactive getBank() {
		...
		final String opt = ctx.properties.containsKey("bank.antipattern") ? ctx.properties.get("bank.antipattern") : "";
		if (opt.equalsIgnoreCase("disable")) {
	 ...
	 * @return the {@link Item} at the specified index; or {@link org.powerbot.script.rs3.tools.Bank#getNil()}
	 */
	 ...
	 * @return the {@link Item} displayed in the tab; otherwise {@link org.powerbot.script.rs3.tools.Bank#getNil()}
	 */
