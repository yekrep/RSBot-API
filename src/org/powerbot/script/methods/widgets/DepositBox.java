...
public class DepositBox extends WorldImpl {
	...
	public boolean open() {
		...
		final GameObject object = world.objects.getNearest(DEPOSIT_BOX_IDS);
	...
	public boolean depositInventory() {
		...
		final int inv = world.inventory.getCount(true);
		if (c.click()) for (int i = 0; i < 25 && world.inventory.getCount(true) == inv; i++) Delay.sleep(100, 200);
		return world.inventory.getCount(true) != inv;
	}
	...
	public boolean depositPouch() {
		final Component c = world.widgets.get(WIDGET, COMPONENT_BUTTON_DEPOSIT_POUCH);
		return c != null && c.isValid() && c.click();
	}
