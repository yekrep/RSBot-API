...
public class Constants {
	...
	static {
		...
		data.put("bank.component.button.deposit.inventory", 12);
		data.put("bank.component.button.deposit.money", 14);
		data.put("bank.component.button.deposit.equipment", 16);
		data.put("bank.component.button.deposit.familiar", 18);
