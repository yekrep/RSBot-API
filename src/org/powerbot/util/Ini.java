...
public class Ini implements Serializable {
	...
	public Ini put(final String k, final Member m) {
		table.put(k, m);
		return this;
	}
	...
	public Ini put(final String k, final Map<String, String> m) {
	...
	public Ini remove(final String k) {
		table.remove(k);
		return this;
	}
	...
	public class Member {
		...
		public String get(final String k, final String d) {
			return values.containsKey(k) ? values.get(k) : d;
		}
		...
		public double getDouble(final String k, final double d) {
			if (!values.containsKey(k)) {
				return d;
			}
			try {
