...
public class Resources {
	public static class Paths {
		...
		public static final String PAUSE_HIGHLIGHT = ROOT_IMG + "/control_pause_highlight.png";
		public static final String PLAY = ROOT_IMG + "/control_play.png";
		public static final String PLAY_HIGHIGHT = ROOT_IMG + "/control_play_highlight.png";
		public static final String STOP = ROOT_IMG + "/control_stop.png";
		public static final String STOP_HIGHLIGHT = ROOT_IMG + "/control_stop_highlight.png";
