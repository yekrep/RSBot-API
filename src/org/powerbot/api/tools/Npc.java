...
import org.powerbot.bot.client.NpcConfig;
...
public class Npc extends Actor implements Identifiable {
	...
	private NpcConfig getConfig() {
		final org.powerbot.bot.client.Npc npc = this.npc.get();
	...
	public boolean isValid() {
		...
		final org.powerbot.bot.client.Npc[] arr = client.getNpcs();
		for (final org.powerbot.bot.client.Npc a : arr) {
			if (a == npc) {
				return true;
			}
		}
