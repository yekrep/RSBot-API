...
import org.powerbot.bot.client.PlayerComposite;
...
public class Player extends Actor {
	...
	@Override
	protected org.powerbot.bot.client.Actor getActor() {
		return player.get();
	}

	@Override
	public String getName() {
		final org.powerbot.bot.client.Player player = this.player.get();
	...
	public boolean isValid() {
		...
		final org.powerbot.bot.client.Player[] arr = client.getPlayers();
		for (final org.powerbot.bot.client.Player a : arr) {
			if (a == player) {
				return true;
			}
		}
