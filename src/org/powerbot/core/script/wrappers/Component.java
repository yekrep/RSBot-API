...
public class Component {//TODO isValid, getChildren, isVisible
	...
	public Point getAbsoluteLocation() {
		...
		int x = 0, y = 0;
		if (pId != -1) {
			final Point point = org.powerbot.core.script.methods.Widgets.get(pId >> 16, pId & 0xffff).getAbsoluteLocation();
			x = point.x;
			y = point.y;
		} else {
		...
		if (pId != -1) {
			final Component child = org.powerbot.core.script.methods.Widgets.get(pId >> 16, pId & 0xffff);
